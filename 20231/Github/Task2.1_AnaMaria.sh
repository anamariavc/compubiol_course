...
blastn -db databases/reference -query sequence_amanita.fasta -evalue 1e-3 -word_size 11 -outfmt '6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore sseq' -out archivo_blast.txt 
##### JOB COMMANDS #### 
